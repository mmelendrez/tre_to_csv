...
Vagrant.configure("2") do |config|
  ...
  config.vm.provision "shell", privileged: false, inline: <<-SHELL
    ...
    ln -s myhome/.vim
    pushd tre_to_csv
    git remote set-url origin https://mmelendrez@github.com/mmelendrez/tre_to_csv.git
    git config --global user.name "Melanie Melendrez"
    git config --global user.email mmelendrez@gmail.com
